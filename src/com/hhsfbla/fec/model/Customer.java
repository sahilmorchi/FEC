...
public class Customer {
    ...
    /**
     * Checks to make sure the customer ID does not already exists
     * @return true if the ID exists, and false if the ID is unique
     * 
     */
    ...
    public boolean checkID(){
    	 int numCount = 0;
    	    ...
    	    for (int custID : idList) {
    	        if (custID == idList.get(numCount)) numCount++;
    	    }
